...
class ConfigurationTest : GradleTest() {
    ...
    fun testIterationsConfig() {
        ...
        runner.updateAnnotations("src/commonMain/kotlin/CommonBenchmark.kt") {
            measurement(iterations = 5, time = 20, timeUnit = "BenchmarkTimeUnit.NANOSECONDS")
        }
    ...
    fun testOutputTimeUnitConfig() {
        ...
        runner.updateAnnotations("src/commonMain/kotlin/CommonBenchmark.kt") {
            measurement(iterations = 1, time = 20, timeUnit = "BenchmarkTimeUnit.NANOSECONDS")
        }
    ...
    fun testWarmUpConfig() {
        ...
        runner.updateAnnotations("src/commonMain/kotlin/CommonBenchmark.kt") {
            warmup(iterations = 1, time = 1, timeUnit = "BenchmarkTimeUnit.NANOSECONDS")
        }
