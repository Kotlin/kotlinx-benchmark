...
To get started, ensure you're using Kotlin 2.3.20 or newer and the latest stable Gradle 8 release or newer.
However, because the Kotlin/WasmJs target is experimental and in an active development phase, it guarantees support
only for the specific Kotlin version used to build the library. For the latest version, this is Kotlin 2.3.20.
