...
| `threads`                           | Sets the number of threads running each benchmark function in parallel. This parameter has effect only for JVM and Native targets.                      | Positive Integer                                           |                                                       | `@Threads(value: Int)`                                       |
